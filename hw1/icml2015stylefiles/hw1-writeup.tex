...
%  The objective function that is being minimized during ridge regression is
...
% %
% %
% Hence, it really make sense to think about $\hat{\lambda} = \frac{\lambda}{N}$ since this removes the dependence on the size of the training data. For the curvefitting dataset we had a $\hat{\lambda}$ value of around $0.1$. Thus we test $\lambda \in [0.01,2]$. 
% %
% %
