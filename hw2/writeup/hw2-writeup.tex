...
\todo{What should I write down for the constraints and objective for the 2D problem given?  Should I actually show each $P,q,G,h,A,b$?}
...
%stdev1 & $0.090$ & $0.035$ & $0.024$ & $0.024$ & $0.024$ \\ \hline
%stdev2 & $0.088$ & $0.016$ & $0.008$ & $0.008$ & $0.007$ \\ \hline
%stdev4 & $0.090$ & $0.035$ & $0.024$ & $0.024$ & $0.024$ \\ \hline
%nonsep & $0.090$ & $0.035$ & $0.024$ & $0.024$ & $0.024$ \\ \hline
%  \end{tabular}
% \caption{Geometric margin $\frac{1}{||\mathbf{w}||}$ for various values of $C$, for each of the provided 2D datasets.}
% \label{weights}
% \end{table}
